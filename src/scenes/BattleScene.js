...
export default class BattleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.loseButton.on('pointerdown', () => {
            ...
            this.endBattle('lose', {
                ...
                // ★★★ スペルミス修正: this.state.manager.f.coin -> this.stateManager.f.coin ★★★
    ...
    stop() {
        ...
        // シーン停止時にゲームオーバーUIがあれば破棄
        if (this.gameOverText) { this.gameOverText.destroy(); this.gameOverText = null; }
        if (this.retryButton) { this.retryButton.destroy(); this.retryButton = null; }
        if (this.titleButton) { this.titleButton.destroy(); this.titleButton = null; }
    }
